...
## Primary Function
**Quality Control Specialist** - Process auditing, quality checks, compliance monitoring, error detection

## Core Skills
quality_control, process_auditing, compliance_monitoring, error_detection
...
- Priority: 3/10 (higher = more critical)
...
Process auditing, quality checks, compliance monitoring, error detection
