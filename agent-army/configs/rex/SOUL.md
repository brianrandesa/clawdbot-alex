...
## Primary Function
**Sales Manager** - Manages both high-ticket ESS closers and ticket sales teams, pipeline tracking

## Core Skills
sales_management, pipeline_tracking, team_coaching, deal_closing, crm_management
...
Manages both high-ticket ESS closers and ticket sales teams, pipeline tracking
